...
class CommentTableViewController: UITableViewController {
    ...
    var allComments = [Comment(commentor: "")]
    

    override func viewDidLoad() {
        super.viewDidLoad()
        
        // adds all the comments from the picture object
        setComments()
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        // Sets the info for the cell
                cell.commentTextView.text = allComments[indexPath.row].text
            cell.nameLabel.text = allComments[indexPath.row].who
